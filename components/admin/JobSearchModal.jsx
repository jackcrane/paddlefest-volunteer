...
const JobSearchModal = (props) => {
  ...
  useEffect(() => {
    (async () => {
      let f = await fetch(
        `https://paddlefestbackend.jackcrane.rocks/list-jobs/expo`
      );
    ...
    (async () => {
      let f = await fetch(
        `https://paddlefestbackend.jackcrane.rocks/list-jobs/launch`
      );
    ...
    (async () => {
      let f = await fetch(
        `https://paddlefestbackend.jackcrane.rocks/list-jobs/midpoint`
      );
    ...
    (async () => {
      let f = await fetch(
        `https://paddlefestbackend.jackcrane.rocks/list-jobs/finishline`
      );
